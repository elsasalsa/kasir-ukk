...
@section('content')
    ...
    <div class="main mt-20 ml-72 mr-8">
        <form class="flex items-center max-w-sm mb-10" method="GET" action="{{ route('petugas.product.index') }}">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-12 bg-white px-4 py-10">
