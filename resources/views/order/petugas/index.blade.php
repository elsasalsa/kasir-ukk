...
@section('content')
    ...
    <div class="main mt-20 ml-72 mr-8">
        <form class="flex items-center max-w-sm mb-10" method="GET" action="{{ route('petugas.order.index') }}">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-12 bg-white p-4">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="px-3 py-1">
                            <div class="flex items-center">
                                Nama Pelanggan
                                <a
                                    href="{{ route('petugas.order.index', ['sort_by' => 'member_name', 'order' => request('order') === 'asc' ? 'desc' : 'asc']) }}"><svg
                        ...
                        <th scope="col" class="px-3 py-1">
                            <div class="flex items-center">
                                Tanggal Penjualan
                                <a
                                    href="{{ route('petugas.order.index', ['sort_by' => 'created_at', 'order' => request('order') === 'asc' ? 'desc' : 'asc']) }}"><svg
                                        class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                        ...
                        <th scope="col" class="px-3 py-1">
                            <div class="flex items-center">
                                Total Harga
                                <a
                                    href="{{ route('petugas.order.index', ['sort_by' => 'total_price', 'order' => request('order') === 'asc' ? 'desc' : 'asc']) }}"><svg
                                        class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                        ...
                        <th scope="col" class="px-3 py-1">
                            <div class="flex items-center">
                                Dibuat Oleh
                                <a
                                    href="{{ route('petugas.order.index', ['sort_by' => 'user_id', 'order' => request('order') === 'asc' ? 'desc' : 'asc']) }}"><svg
                                        class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z" />
                                        ...
                                        <div class="relative bg-white dark:bg-gray-700 rounded-lg shadow-lg">
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                <div class="overflow-x-auto">
                                                    ...
                                                    <p class="text-right text-base font-bold mr-8 mt-3">Total Rp.
                                                        {{ number_format($order->total_price, 0, ',', '.') }}</p>

                                                    <div class="mt-8">
                                                        <p class="text-base">Dibuat pada : {{ $order->created_at }}</p>
                                                        <p class="text-base mt-1">Oleh :
            ...
            <nav class="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4"
                ...
                <span
                    ...
                    Showing
                    <span
                        class="font-semibold text-gray-900 dark:text-white">{{ $orders->firstItem() }}-{{ $orders->lastItem() }}</span>
                    of
